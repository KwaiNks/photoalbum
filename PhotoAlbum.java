...
public class PhotoAlbum {
    ...
    public void movePhotoBetweenPages(int positionOfPhotoOnPage, int pageCurrentlyHoldingPhoto,
            int pageWherePhotoWillBeMovedTo) {
        Photo photo = pages.get(pageCurrentlyHoldingPhoto).getPhoto(positionOfPhotoOnPage);
    ...
    public int removeAllPagesInAlbum() {
        pages.clear();
        return pages.size();
    }
